...
from FWCore.ParameterSet.VarParsing import *
print(VarParsing)
...
files = ['/store/group/dpg_bril/comm_bril/phase2-sim/FBCM/MinBias/FBCMMinBias/210127_070946/0000/MinBias_14TeV_pythia8_TuneCUETP8M1_GEN_SIM_{0}.root'.format(d) for d in range(1,501) if d not in [26,129] ]

process.mix.input.fileNames = cms.untracked.vstring(files)
...
if options.aging == 0:
        ...
        raise ValueError("invalid aging option ({0}), possible values are 0,1000,3000,4000".format(options.aging))

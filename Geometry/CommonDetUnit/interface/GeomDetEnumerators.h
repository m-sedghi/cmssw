...
namespace GeomDetEnumerators {
  ...
  constexpr unsigned int subDetId[22] = {1, 2, 3, 5, 4, 6, 0, 0, 0, 0, 0,
                                         0, 5, 4, 1, 2, 1, 2, 2, 2, 1, 0};  // don't ask, don't ask, simply do not ask!
  ...
  bool isFbcm(GeomDetEnumerators::SubDetector m);

...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring(
        ...
        'Geometry/FbcmCommonData/test/TMP_cmsextent.xml',
...
#        'Geometry/CMSCommonData/data/muonBase/2026/v3/muonBase.xml',
	    ...
	    'Geometry/FbcmCommonData/data/v1/fbcm.xml',
		'Geometry/FbcmCommonData/data/v1/FbcmSpecs.xml',
		'Geometry/FbcmSimData/data/v1/FbcmSens.xml',

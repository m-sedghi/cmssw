...
# with command line options: --evt_type SingleNuE10_cfi -s GEN,SIM --mc --fileout file:GEN_SIM.root --conditions 110X_mcRun4_realistic_v3 --era Phase2C8 --datatier GEN-SIM-DIGI-RAW --geometry Extended2026D41 --eventcontent FEVTDEBUGHLT --python_filename GEN_SIM_cfg.py --customise SLHCUpgradeSimulations/Configuration/aging.customise_aging_1000,Configuration/DataProcessing/Utils.addMonitoring --nThreads 8 -n 10 --no_exe
